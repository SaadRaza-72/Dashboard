  ...
  return (
    <div className=" w-full py-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left Section (Highlights, Images, News) */}
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="relative">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600">
                  A brand new creative look theme for your business...
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Interest Section */}
          <div className="bg-white p-4 shadow-lg rounded-lg">
            <h3 className="font-semibold text-lg mb-4">Interest</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <img src="./image1.jpg" className="w-full rounded-lg" alt="Interest" />
              <img src="./image8.jpg" className="w-full rounded-lg" alt="Interest" />
              <img src="./image3.jpg" className="w-full rounded-lg" alt="Interest" />
              <img src="./image4.jpg" className="w-full rounded-lg" alt="Interest" />
            </div>
          </div>

          {/* Latest News */}
          <div className="bg-white p-4 shadow-lg rounded-lg">
            <h3 className="font-semibold text-lg mb-4">Our Latest News</h3>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <img src="./image4.jpg" className="w-12 h-12 rounded-lg" alt="News" />
                <p className="text-gray-700">Collection of textile samples</p>
              </div>
              <div className="flex items-center space-x-3">
                <img src="./image1.jpg" className="w-12 h-12 rounded-lg" alt="News" />
                <p className="text-gray-700">Collection of textile samples</p>
              </div>
            </div>
          </div>
        ...
        {/* Right Section (Posts) */}
        <div className="bg-white p-4 shadow-lg rounded-lg h-[1236px] overflow-y-auto fit-content">
          {/* Tabs */}
          ...
          <div className="mt-4">
            ...
            <h2 className="text-lg font-bold mt-2">
              Collection of textile samples lays spread
            </h2>
            <p className="text-gray-600">
              A product promotion layout for fabric samples...
            </p>
